...
<div class="bash-example">
    ...
    --form "fullname=amniihfqcoynlazghdtqt"\
    --form "email=andreanne00@example.org"\
    --form "password='YAKYLk4&gt;SJIrIV#lz."\
    --form "birth=2025-04-14T06:29:27"\
    --form "gender=male"\
    --form "user_desc=consequatur"\
    --form "character_img=@C:\Users\user\AppData\Local\Temp\php1DFE.tmp" </code></pre></div>
...
body.append('fullname', 'amniihfqcoynlazghdtqt');
body.append('email', 'andreanne00@example.org');
body.append('password', ''YAKYLk4&gt;SJIrIV#lz.');
body.append('birth', '2025-04-14T06:29:27');
body.append('gender', 'male');
body.append('user_desc', 'consequatur');
body.append('character_img', document.querySelector('input[name="character_img"]').files[0]);
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="birth"                data-endpoint="POSTapi-v1-register"
               value="2025-04-14T06:29:27"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-04-14T06:29:27</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<ul style="list-style-type: square;"><li><code>male</code></li> <li><code>female</code></li></ul>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>character_img</code></b>&nbsp;&nbsp;
<small>file</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="character_img"                data-endpoint="POSTapi-v1-register"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\user\AppData\Local\Temp\php1DFE.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>user_desc</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="user_desc"                data-endpoint="POSTapi-v1-register"
               value="consequatur"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="birth"                data-endpoint="POSTapi-v1-forgot-password"
               value="2025-04-14T06:29:27"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-04-14T06:29:27</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="POSTapi-v1-forgot-password"
               value="Z5ij-e/dl4m{o,"
               data-component="body">
    <br>
